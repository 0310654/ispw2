...
public class DemoEventiDAO implements EventiDAO {
    ...
    public DemoEventiDAO() {
        ...
        eventi.add(new Evento("001", "Concerto Coldplay", "LiveNation", "Comune di Roma",
        ...
        eventi.add(new Evento("002", "Mostra Van Gogh", "ArteMuse", "Museo Milano",
        ...
        eventi.add(new Evento("003", "Festival del Cinema", "CineWorld", "Città di Venezia",
        ...
        eventi.add(new Evento("004", "Fiera del Libro", "Mondadori", "Comune di Torino",
        ...
        eventi.add(new Evento("005", "Opera La Traviata", "Scala", "Comune di Milano",
