...
public class DemoUserDAO implements UserDAO {
    ...
    public static FiltriBean getFiltri() {
        ...
        filtri.addEvento("Concerto");
        filtri.addEvento("Teatro");
        filtri.addEvento("Cinema");

        filtri.addLocalita("Roma");
        filtri.addLocalita("Milano");
        filtri.addLocalita("Verona");

        filtri.addPrezzo("50€-100€");
        filtri.addPrezzo("100€-200€");
